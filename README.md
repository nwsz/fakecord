...
## Versions (V3: Best)
### **V1**
You can find this [here](https://nwsz.github.io/discord-dm-faker/). V1 includes the basic stuff, some templates, replies, bots, etc. Very nice and simple to use.
### **V2**
You can find this [here](https://nwsz.github.io/discord-dm-faker/v2). This includes better UI reorganising for messages, *images, embeds, and links*.
### **V3**
You can find this [here](https://nwsz.github.io/discord-dm-faker/v3). This includes even better UI reorganising for messages, *images, embeds, and links*. Furthermore, it contains gradient roles, and a more premium feel. This is the best version released yet
